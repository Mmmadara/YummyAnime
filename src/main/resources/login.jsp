...
<!DOCTYPE html>
  ...
  <body>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item"> <a class="nav-link" href="../webapp/WEB-INF/view">Home</a></li>
    ...
    <div class="block1">
      ...
      <form action="" target="_parent" method="post" enctype="text/plain" style="text-align: center">
      ...
      <br><br>
        <div class="center text-center">If you still have not registered on our site then create new account   <i class="fas fa-arrow-right"></i>    <a href="./register" class="btn btn-info">Register</a></div>
