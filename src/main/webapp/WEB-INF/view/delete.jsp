...
<!DOCTYPE html>
  ...
  <head>
    ...
    <script>
      ...
      var id = 'http://localhost:8081/yummyAnime/api/delete?username=';
      var href
      function update() {
  ...
  <body>
    ...
    <div class="block1">
      <form style="text-align: center">
        <br><br>
        <label>Username you want to delete:</label><br>
        <input id="search" type="text" name="name" value="" onchange="update()"><br><br>
        <a id="ssilka" href="javascript: showid();"><button type="button">Delete</button></a>
      </form>
      <br><br><br>
