...
<!DOCTYPE html>
  ...
  <body>
    ...
    <div class="block1">
      <form:form action="./api/update" modelAttribute="user" method="post" style="text-align: center">
        <label class="form">Your email:</label><br>
        <form:input path="username" placeholder="Your email" class="form-control"/><br>
        <label class="form">Your password:</label><br>
