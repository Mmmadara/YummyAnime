...
<!DOCTYPE html>
  ...
  <head>
    ...
    <script>
      ...
      var username = 'http://localhost:8081/yummyAnime/update?username=';
      var href
      function update() {
        href = document.getElementById("search").value;
      }
      function showid() {
        document.location.href = username + href;
      }
    </script>
  ...
  <body>
    ...
    <div class="block1">
      <form style="text-align: center">
        <br><br>
        <label>Username you want to update:</label><br>
        <input id="search" type="text" name="name" value="" onchange="update()"><br><br>
        <a id="ssilka" href="javascript: showid();"><button type="button">Find to Update</button></a>
      </form>
      <br><br><br>
